...
function turnOnLight(id) {
    request({
        url: 'http://192.168.1.127:8083/ZAutomation/api/v1/devices/' + id + '/command/on',
        method: 'GET',
        json: true,
        headers: {
...
function turnOffLight(id) {
    request({
        url: 'http://192.168.1.127:8083/ZAutomation/api/v1/devices/' + id + '/command/off',
        method: 'GET',
        json: true,
        headers: {
            ZWAYSession: ZWAYSession
...
function getLight(id) {
    return new Promise((resolve, reject) => {
        function recursive() {
            request({
                url: 'http://192.168.1.127:8083/ZAutomation/api/v1/devices/' + id,
                method: 'GET',
                json: true,
                headers: {
                    ZWAYSession: ZWAYSession
